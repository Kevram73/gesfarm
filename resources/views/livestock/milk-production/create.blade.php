...
@section('title', 'Nouvelle Production Laitière')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow-md p-6">
        <h1 class="text-2xl font-bold text-gray-900 mb-6">Nouvelle Production Laitière</h1>

        <form action="{{ route('livestock.milk-production.store') }}" method="POST">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label for="quantity" class="block text-sm font-medium text-gray-700 mb-2">Quantité (L) *</label>
                ...
                <div>
                    ...
                    <input type="text" name="quality" id="quality" value="{{ old('quality') }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg" placeholder="Ex: Excellente, Bonne, etc.">
                    @error('quality')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mt-6 flex items-center justify-end space-x-4">
                <a href="{{ route('livestock.milk-production.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
                    Annuler
                </a>
