...
<div class="max-w-4xl mx-auto">
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-1">Enregistrez un nouveau paiement</p>
    </div>

    <form method="POST" action="{{ route('payments.store') }}" class="bg-white rounded-lg shadow-md overflow-hidden">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="harvest_id" name="harvest_id"
                        ...
                        @foreach($harvests as $harvest)
                            <option value="{{ $harvest->id }}" {{ old('harvest_id', $selectedHarvest?->id) == $harvest->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select id="method" name="method"
                        ...
                        <option value="CHECK" {{ old('method') == 'CHECK' ? 'selected' : '' }}>Chèque</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="date" id="paid_at" name="paid_at" value="{{ old('paid_at', date('Y-m-d')) }}"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                </div>
