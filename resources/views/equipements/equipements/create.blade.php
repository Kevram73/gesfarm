...
<div class="max-w-4xl mx-auto">
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-1">Ajoutez un nouvel équipement</p>
    </div>

    <form method="POST" action="{{ route('equipment.store') }}" class="bg-white rounded-lg shadow-md overflow-hidden">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="status" name="status"
                        ...
                        <option value="REPAIR" {{ old('status') == 'REPAIR' ? 'selected' : '' }}>Réparation</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="number" id="quantity" name="quantity" value="{{ old('quantity') }}" step="0.01" min="0"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <input type="number" id="min_stock" name="min_stock" value="{{ old('min_stock') }}" step="0.01" min="0"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <input type="date" id="maintenance_date" name="maintenance_date" value="{{ old('maintenance_date') }}"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                </div>
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-end space-x-4">
            ...
            <button type="submit" class="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors font-semibold">
                <i class="fas fa-save mr-2"></i> Créer l'équipement
            </button>
        </div>
    </form>
</div>
