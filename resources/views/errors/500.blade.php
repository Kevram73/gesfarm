        ...
        <div class="max-w-md w-full text-center">
            <div class="mb-8">
                <div class="inline-block p-6 bg-red-100 rounded-full mb-4">
                    <i class="fas fa-server text-red-600 text-6xl"></i>
                </div>
            ...
            <div class="space-y-4">
                ...
                <button onclick="window.location.reload()" class="inline-block w-full px-6 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors font-semibold">
